...
from lib.kindle_unpack import Sectionizer
from lib.kindle_unpack import MobiHeader
...
class APNXBuilder(object):
    ...
    def write_apnx(self, mobi_file_path, apnx_path, page_count=0):
        ...
        with open(mobi_file_path, 'rb') as mf:
            section = Sectionizer(mobi_file_path)
    ...
    def generate_apnx(self, pages, apnx_meta):
        ...
        content_header = str.encode(content_header)
        page_header = str.encode(page_header)
